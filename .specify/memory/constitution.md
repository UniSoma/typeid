...
- **Exhaustive examples**: README MUST include examples for all major use cases; API documentation is automatically generated by cljdoc upon deployment
...
- **Schema documentation**: Data schemas (as predicate specs) MUST be documented in README and/or API docs (cljdoc)
